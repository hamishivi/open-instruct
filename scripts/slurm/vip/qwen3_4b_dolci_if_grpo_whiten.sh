#!/usr/bin/env bash
#SBATCH --job-name=vip-dolci-if-grpo-whiten
...
DDMM=$(date +"%d%m")
export EXP_NAME="${EXP_NAME:-vip_dolci_if_grpo_whiten_ctr_g8_p32_zvf_tis2_${DDMM}_q3_4b}"
...
exec bash scripts/slurm/vip/qwen3_4b_centered_grpo.sh
